...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const normalContent = {
        ...
        project1Title: "Mentoring & Community Building",
        project1Desc: "> Leveraging my role as a student mentor and National Technical Honor Society member to foster collaboration and inspire growth within academic communities.",
        project2Title: "1984 Corvette Restoration",
        project2Desc: "> A long-term passion project involving the mechanical and aesthetic restoration of a vintage 1984 Corvette, applying problem-solving and meticulous attention to detail.",
        project3Title: "Personal Growth & Skill Acquisition",
        project3Desc: "> Documenting my journey of continuous learning and skill development, transitioning from iOS development to a cybersecurity specialization post-graduation.",
        ...
        blogHeading: "Latest Insights",blog1Title: "Tackling Memory Leaks in iOS Development",
        blog1Title: "Tackling Memory Leaks in iOS Development",
        blog1Desc: "> A deep dive into my process for diagnosing and resolving critical memory leaks and application crashes, ensuring robust iOS app performance.",
        blog2Title: "The Importance of Effective Technical Communication",
        blog2Desc: "> Insights from my experience communicating complex technical concepts to diverse teams, bridging gaps between development and non-technical stakeholders.",
        blog3Title: "Navigating Personal Growth After Graduation",
        blog3Desc: "> Insights into adapting to new challenges, embracing lifelong learning, and evolving my professional identity beyond formal education.",
    ...
    const cyberpunkContent = {
        ...
        skillsHeading: "SKILLS // MATRIX",
        techSkillsHeading: "TECHNICAL PROWESS",
        techSkillsList: [
            "THREAT ANALYSIS",
            "VULNERABILITY ASSESSMENTS",
            "NETWORK SECURITY PROTOCOLS",
            "SECURITY MONITORING SYSTEMS",
            "HARDWARE INSTALLATION INFRA",
            "SYSTEM TROUBLESHOOTING LOGIC",
            "TECHNICAL WRITING & DOCUMENT GENERATION"
        ],
        softSkillsHeading: "INTER PERSONAL SKILLS",
        softSkillsList: [
            "EXCELLENT COMMUNICATION SKILLS",
            "STRONG TEAM COLLABORATION",
            "ADAPTIVE PROBLEM SOLVING",
            "CRITICAL THINKING ALGORITHMS",
            "EFFECTIVE MULTITASK CAPACITY"
        ],
        certsHeading: "CERTIFICATION // REGISTRY",
        projectsHeading: "PROJECT_FILES // DATABASE",
        project1Title: "MENTORING & COMMUNITY BUILD",
        project1Desc: "> LEVERAGING MY ROLE AS A STUDENT MENTOR AND NATIONAL TECHNICAL HONOR SOCIETY MEMBER TO FOSTER COLLABORATION AND INSPIRE GROWTH WITHIN ACADEMIC COMMUNITIES.",
        project2Title: "1984 CORVETTE RESTORATION LOG",
        project2Desc: "> A LONG-TERM PASSION PROJECT INVOLVING THE MECHANICAL AND AESTHETIC RESTORATION OF A VINTAGE 1984 CORVETTE, APPLYING PROBLEM-SOLVING AND METICULOUS ATTENTION TO DETAIL.",
        project3Title: "PERSONAL GROWTH & SKILL ACQUISITION PROTOCOL",
        project3Desc: "> DOCUMENTING MY JOURNEY OF CONTINUOUS LEARNING AND SKILL DEVELOPMENT, TRANSITIONING FROM IOS DEVELOPMENT TO A CYBERSECURITY SPECIALIZATION POST-GRADUATION.",
        allProjectsButtonText: "VIEW ALL INSIGHTS &rarr;",
        ...
        blogHeading: "INSIGHT STREAM // DATALOG",
        blog1Title: "TACKLING MEMORY LEAKS IN IOS DEVELOPMENT",
        blog1Desc: "> A DEEP DIVE INTO MY PROCESS FOR DIAGNOSING AND RESOLVING CRITICAL MEMORY LEAKS AND APPLICATION CRASHES, ENSURING ROBUST IOS APP PERFORMANCE.",
        blog2Title: "THE IMPORTANCE OF EFFECTIVE TECHNICAL COMMUNICATION",
        blog2Desc: "> INSIGHTS FROM MY EXPERIENCE COMMUNICATING COMPLEX TECHNICAL CONCEPTS TO DIVERSE TEAMS, BRIDGING GAPS BETWEEN DEVELOPMENT AND NON-TECHNICAL STAKEHOLDERS.",
        blog3Title: "NAVIGATING PERSONAL GROWTH POST-GRADUATION",
        blog3Desc: "> INSIGHTS INTO ADAPTING TO NEW CHALLENGES, EMBRACING LIFELONG LEARNING, AND EVOLVING MY PROFESSIONAL IDENTITY BEYOND FORMAL EDUCATION.",
